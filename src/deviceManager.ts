...
// ============================================
// On-screen keyboard script (UPDATED)
// ============================================
...
window.__triggerVirtualKeyboardIfNeeded = function(){
  ...
  if(isValidInput){
    console.log('[VKB] Server trigger → Show keyboard for:', el);
    showKeyboard(el);
  } else if(keyboardContainer && keyboardContainer.classList.contains('vkb-visible')){
    console.log('[VKB] Server trigger → Hide keyboard (no input focused)');
    hideKeyboard();
  }
};
